package com.dfinn.wallet.feature_dapp_impl.domain.common

import com.dfinn.wallet.common.utils.mapToSet
import com.dfinn.wallet.feature_dapp_api.data.model.DApp
import com.dfinn.wallet.feature_dapp_api.data.model.DappMetadata
import com.dfinn.wallet.feature_dapp_impl.data.mappers.mapDappCategoriesToDescription
