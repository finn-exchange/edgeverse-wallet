package com.dfinn.wallet.feature_dapp_impl.domain.browser.metamask.sign
...
import com.dfinn.wallet.feature_account_api.data.mappers.mapGradientToUi
import com.dfinn.wallet.feature_account_api.data.secrets.getEthereumKeypair
import com.dfinn.wallet.feature_account_api.data.secrets.signEthereum
import com.dfinn.wallet.feature_account_api.data.secrets.signEthereumPrefixed
...
import com.dfinn.wallet.feature_dapp_impl.data.network.ethereum.EthereumApi
import com.dfinn.wallet.feature_dapp_impl.data.network.ethereum.EthereumApiFactory
import com.dfinn.wallet.feature_dapp_impl.domain.browser.metamask.MetamaskInteractor
import com.dfinn.wallet.feature_dapp_impl.domain.browser.signExtrinsic.ConfirmDAppOperationValidationFailure.NotEnoughBalanceToPayFees
...
import com.dfinn.wallet.feature_dapp_impl.web3.metamask.model.MetamaskSendTransactionRequest
import com.dfinn.wallet.feature_dapp_impl.web3.metamask.model.MetamaskSendTransactionRequest.Payload
import com.dfinn.wallet.feature_dapp_impl.web3.metamask.model.MetamaskTransaction
import com.dfinn.wallet.feature_dapp_impl.web3.metamask.model.PersonalSignMessage
import com.dfinn.wallet.feature_dapp_impl.web3.metamask.model.TypedMessage
