...
import com.dfinn.wallet.feature_dapp_impl.domain.browser.BrowserPage
import com.dfinn.wallet.feature_dapp_impl.domain.browser.BrowserPageAnalyzed
...
import com.dfinn.wallet.feature_dapp_impl.presentation.browser.signExtrinsic.DAppSignRequester
import com.dfinn.wallet.feature_dapp_impl.presentation.browser.signExtrinsic.awaitConfirmation
import com.dfinn.wallet.feature_dapp_impl.presentation.common.favourites.RemoveFavouritesPayload
import com.dfinn.wallet.feature_dapp_impl.presentation.search.DAppSearchRequester
import com.dfinn.wallet.feature_dapp_impl.presentation.search.SearchPayload
import com.dfinn.wallet.feature_dapp_impl.web3.session.Web3Session.Authorization.State
...
import com.dfinn.wallet.feature_dapp_impl.web3.states.hostApi.AuthorizeDAppPayload
import com.dfinn.wallet.feature_dapp_impl.web3.states.hostApi.ConfirmTxRequest
import com.dfinn.wallet.feature_dapp_impl.web3.states.hostApi.ConfirmTxResponse
