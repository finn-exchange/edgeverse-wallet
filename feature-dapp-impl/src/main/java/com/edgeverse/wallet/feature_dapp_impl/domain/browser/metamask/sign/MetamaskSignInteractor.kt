package com.edgeverse.wallet.feature_dapp_impl.domain.browser.metamask.sign
...
import com.edgeverse.wallet.common.validation.EmptyValidationSystem
...
import com.edgeverse.wallet.feature_account_api.data.mappers.mapGradientToUi
import com.edgeverse.wallet.feature_account_api.data.secrets.getEthereumKeypair
import com.edgeverse.wallet.feature_account_api.data.secrets.signEthereum
import com.edgeverse.wallet.feature_account_api.data.secrets.signEthereumPrefixed
...
import com.edgeverse.wallet.feature_dapp_impl.data.network.ethereum.EthereumApi
...
import com.edgeverse.wallet.feature_dapp_impl.domain.browser.signExtrinsic.ConfirmDAppOperationValidationFailure.NotEnoughBalanceToPayFees
import com.edgeverse.wallet.feature_dapp_impl.domain.browser.signExtrinsic.ConfirmDAppOperationValidationSystem
import com.edgeverse.wallet.feature_dapp_impl.domain.browser.signExtrinsic.DAppSignInteractor
import com.edgeverse.wallet.feature_dapp_impl.domain.browser.signExtrinsic.convertingToAmount
...
import com.edgeverse.wallet.feature_dapp_impl.web3.metamask.model.MetamaskSendTransactionRequest.Payload
import com.edgeverse.wallet.feature_dapp_impl.web3.metamask.model.MetamaskTransaction
import com.edgeverse.wallet.feature_dapp_impl.web3.metamask.model.PersonalSignMessage
import com.edgeverse.wallet.feature_dapp_impl.web3.metamask.model.TypedMessage
...
import com.edgeverse.wallet.feature_wallet_api.domain.validation.sufficientBalance
