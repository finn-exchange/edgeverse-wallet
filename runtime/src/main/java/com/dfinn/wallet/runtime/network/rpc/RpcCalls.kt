package com.dfinn.wallet.runtime.network.rpc

import com.dfinn.wallet.common.data.network.runtime.binding.BlockNumber
import com.dfinn.wallet.common.data.network.runtime.calls.FeeCalculationRequest
import com.dfinn.wallet.common.data.network.runtime.calls.GetBlockHashRequest
import com.dfinn.wallet.common.data.network.runtime.calls.GetBlockRequest
import com.dfinn.wallet.common.data.network.runtime.calls.GetFinalizedHeadRequest
import com.dfinn.wallet.common.data.network.runtime.calls.GetHeaderRequest
import com.dfinn.wallet.common.data.network.runtime.calls.NextAccountIndexRequest
import com.dfinn.wallet.common.data.network.runtime.model.FeeResponse
import com.dfinn.wallet.common.data.network.runtime.model.SignedBlock
import com.dfinn.wallet.common.data.network.runtime.model.SignedBlock.Block.Header
import com.dfinn.wallet.common.utils.extrinsicHash
import com.dfinn.wallet.runtime.extrinsic.ExtrinsicStatus
import com.dfinn.wallet.runtime.extrinsic.asExtrinsicStatus
