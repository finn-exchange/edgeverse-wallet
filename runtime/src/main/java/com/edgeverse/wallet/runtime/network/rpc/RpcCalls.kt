package com.edgeverse.wallet.runtime.network.rpc

import com.edgeverse.wallet.common.data.network.runtime.binding.BlockNumber
import com.edgeverse.wallet.common.data.network.runtime.calls.FeeCalculationRequest
import com.edgeverse.wallet.common.data.network.runtime.calls.GetBlockHashRequest
import com.edgeverse.wallet.common.data.network.runtime.calls.GetBlockRequest
import com.edgeverse.wallet.common.data.network.runtime.calls.GetFinalizedHeadRequest
import com.edgeverse.wallet.common.data.network.runtime.calls.GetHeaderRequest
import com.edgeverse.wallet.common.data.network.runtime.calls.NextAccountIndexRequest
import com.edgeverse.wallet.common.data.network.runtime.model.FeeResponse
import com.edgeverse.wallet.common.data.network.runtime.model.SignedBlock
import com.edgeverse.wallet.common.data.network.runtime.model.SignedBlock.Block.Header
import com.edgeverse.wallet.common.utils.extrinsicHash
import com.edgeverse.wallet.runtime.extrinsic.ExtrinsicStatus
import com.edgeverse.wallet.runtime.extrinsic.asExtrinsicStatus
