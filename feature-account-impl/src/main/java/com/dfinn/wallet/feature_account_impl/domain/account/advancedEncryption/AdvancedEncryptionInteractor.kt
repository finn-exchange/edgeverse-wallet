...
import com.dfinn.wallet.common.data.mappers.mapEncryptionToCryptoType
import com.dfinn.wallet.common.data.secrets.v2.SecretStoreV2
import com.dfinn.wallet.common.data.secrets.v2.derivationPath
import com.dfinn.wallet.common.data.secrets.v2.ethereumDerivationPath
import com.dfinn.wallet.common.data.secrets.v2.substrateDerivationPath
import com.dfinn.wallet.common.utils.DEFAULT_DERIVATION_PATH
import com.dfinn.wallet.common.utils.fold
import com.dfinn.wallet.common.utils.input.Input
import com.dfinn.wallet.common.utils.input.disabledInput
import com.dfinn.wallet.common.utils.input.modifiableInput
import com.dfinn.wallet.common.utils.input.unmodifiableInput
import com.dfinn.wallet.common.utils.nullIfEmpty
...
import com.dfinn.wallet.feature_account_api.domain.model.chainAccountFor
import com.dfinn.wallet.feature_account_api.presenatation.account.add.chainIdOrNull
